...
extern	int		__stdcall TmcInitializeEx( int wire, char* adr, int* id , int tmo) ;
...
extern	int		__stdcall TmcWaitSRQ(int id, char* stsbyte, int tmo) ;
...
extern	int		__stdcall TmcGetWireInfo( int id, int* wire );
...
extern	int	__stdcall xTmcInitializeEx( int wire, char* adr, int* id, int tmo ) ;
...
extern	int	__stdcall xTmcGetWireInfo( int id, int* wire );
